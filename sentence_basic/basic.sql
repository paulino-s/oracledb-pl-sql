...
SELECT 'Usuario: ' || USER || ' ' || 'otra cadena de prueba'
FROM DUAL;

SELECT ('Usuario: ' | | USER || ', el día de hoy es: ' | | SYSDATE) AS "Encabezado"
FROM DUAL;

SELECT 'I''am ' || USER FROM DUAL;
...
'USUARIO:'||USER||''||'OTRACADENADEPRUEBA'                                                                                                                     
---------------------------------------------------------------------------------------------------------------------------------------------------------------
Usuario: HR1 otra cadena de prueba


Encabezado                                                                                                                                                           
---------------------------------------------------------------------------------------------------------------------------------------------------------------------
Usuario: HR1, el día de hoy es: 28/06/21
...
SELECT ('Usuario: ' || USER || ' ' || 'otra cadena de prueba') AS "Encabezado" 
FROM DUAL;
